                ...
                auth.sendPasswordResetEmail(pemail.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(PoliceForgetPasswordActivity.this,"Link is sent to you mail",Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(PoliceForgetPasswordActivity.this, ""+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
