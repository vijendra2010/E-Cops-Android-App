...
public class Welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedPreferences.getBoolean("loginstatus", false)){
            ...
            Intent intent = new Intent(Welcome.this, CitizenDashboard.class);
        ...
        if (sharedPreferences1.getBoolean("loginstatus", false)){
            ...
            Intent intent1 = new Intent(Welcome.this, PoliceDashboard.class);
        ...
        citizen_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Welcome.this, CitizenRegisterActivity.class);
                startActivity(intent);
//                finish();
            }
        });
        ...
        police_signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Welcome.this, PoliceRegisterAcitivity.class);
                startActivity(intent);
//                finish();
            }
        });
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Welcome.this, LoginAcitivity.class);
                startActivity(intent);
//                finish();
            }
        });
