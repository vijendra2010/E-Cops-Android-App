...
//        });
    ...
    private void getCitizenSignUpData(){
     ...
     //   final String number = c_user_number.getText().toString();
        ...
        if (flag1){
            Toast.makeText(CitizenRegisterActivity.this,"Invalid name entered !!",Toast.LENGTH_SHORT).show();
        } else if (flag2){
            Toast.makeText(CitizenRegisterActivity.this,"Invalid email entered !!",Toast.LENGTH_SHORT).show();
        }else if (flag3){
