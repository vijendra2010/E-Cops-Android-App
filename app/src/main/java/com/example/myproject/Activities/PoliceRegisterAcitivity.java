...
import com.example.myproject.Pojo.CitizenUserPojo;
import com.example.myproject.Pojo.PoliceUserPojo;
...
//        });
    ...
    private void getPoliceSignUpData(){
       ...
       // Log.d("12345", "getCitizenSignUpData: "+cid+" "+name+" "+number+" "+password+" "+confirmPass);
        ...
        if (flag1){
            Toast.makeText(PoliceRegisterAcitivity.this,"Invalid name entered !!",Toast.LENGTH_SHORT).show();
        } else if (flag2){
            Toast.makeText(PoliceRegisterAcitivity.this,"Invalid email entered !!",Toast.LENGTH_SHORT).show();
        }else if (flag3){
            Toast.makeText(PoliceRegisterAcitivity.this,
                    "Your password is too weak it should contain atleast 8 characters",Toast.LENGTH_SHORT).show();
        }else if (flag4){
            Toast.makeText(PoliceRegisterAcitivity.this,"Password mismatch !!",Toast.LENGTH_SHORT).show();
        }else{
            ...
            auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    if (task.isSuccessful()){
                        ...
                        auth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful())
                                {
                                    Toast.makeText(PoliceRegisterAcitivity.this, "Verification mail sent",Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(PoliceRegisterAcitivity.this, ""+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }else{
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(PoliceRegisterAcitivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
...
//            finish();
    ...
    private void verification() {
        ...
        if (flag1){
            Toast.makeText(PoliceRegisterAcitivity.this,"Please enter name!!",Toast.LENGTH_SHORT).show();
        } else if (flag2){
            Toast.makeText(PoliceRegisterAcitivity.this,"Please enter name!!",Toast.LENGTH_SHORT).show();
        }else if (flag3){
            Toast.makeText(PoliceRegisterAcitivity.this,
