...
import com.example.myproject.Adapters.SearchCustomAdapter;
...
//        progressDialog.show();
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SearchActivity.this,CitizenDashboard.class);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               // progressDialog.cancel();
                SearchCustomAdapter adapter = new SearchCustomAdapter(arrayList, SearchActivity.this);
