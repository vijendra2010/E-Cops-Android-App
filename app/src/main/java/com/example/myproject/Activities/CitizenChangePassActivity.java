                ...
                if (!error){
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(flag==1){
                                Toast.makeText(CitizenChangePassActivity.this, "Password Change Successfull", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(CitizenChangePassActivity.this,CitizenDashboard.class);
                                startActivity(intent);
                                finish();
                            }
                            else{
                                Toast.makeText(CitizenChangePassActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                            }
