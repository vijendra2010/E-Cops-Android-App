...
public class MissedDetails extends AppCompatActivity {
    ...
    private void fetchLocation() {
        ...
        if (ContextCompat.checkSelfPermission(MissedDetails.this,
                Manifest.permission.ACCESS_COARSE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            // Permission is not granted
            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(MissedDetails.this,
                    Manifest.permission.ACCESS_COARSE_LOCATION)) {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(MissedDetails.this,
                    ...
                    .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                try {
                                    Geocoder geocoder = new Geocoder(MissedDetails.this, Locale.getDefault());
    ...
    public void onChecked(View view) {
        ...
        radioButton = findViewById(selectID);
        if (selectID == -1) {
            Toast.makeText(MissedDetails.this, "Please select gender", Toast.LENGTH_SHORT).show();
        }
    }
...
//    }
    ...
    private void getMissedData() {
        ...
        if (f1) {
            Toast.makeText(MissedDetails.this, "Please enter valid details", Toast.LENGTH_SHORT).show();
        } else if (f2) {
            Toast.makeText(MissedDetails.this, "Please enter valid details", Toast.LENGTH_SHORT).show();
        } else if (f3) {
            Toast.makeText(MissedDetails.this, "Please enter valid details", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(MissedDetails.this, "Please select image", Toast.LENGTH_SHORT).show();
        } else {
            ...
            reference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(MissedDetails.this,"Submitted Successfully!!",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(MissedDetails.this, CitizenDashboard.class);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(MissedDetails.this, "network error", Toast.LENGTH_SHORT).show();
                }
            });
