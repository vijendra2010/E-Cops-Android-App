...
public class CitizenDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBarDrawerToggle = new ActionBarDrawerToggle(CitizenDashboard.this, drawerLayout, R.string.open, R.string.close );
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    ...
                    case R.id.citizen_logout:
                        ...
                        editor.clear();
                        editor.commit();
                        Intent intent1 = new Intent(CitizenDashboard.this, LoginAcitivity.class);
        ...
        // SLIDER CODE FOR PUTTING IMAGES INTO ARRAY ----STARTS-----
            ...
            missed.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(CitizenDashboard.this,MissedDetails.class);
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CitizenDashboard.this,SightedActivity.class);
                startActivity(intent);
                }
            });
            ...
            search.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(CitizenDashboard.this,SearchActivity.class);
                    startActivity(intent);
                }
            });
            ...
            @Override
            public void onClick(View v) {
                    Intent intent = new Intent(CitizenDashboard.this,CitizenSettingsActivity.class);
                    startActivity(intent);
                  }
            });
