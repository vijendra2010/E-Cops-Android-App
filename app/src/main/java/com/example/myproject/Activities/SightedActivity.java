...
import com.example.myproject.Helper.SelectImageHelper;
...
public class SightedActivity extends AppCompatActivity {
   ...
   // TextView sighted_location;
    ...
    private void fetchLocation() {
        ...
        if (ContextCompat.checkSelfPermission(SightedActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {
            Log.d("12345", "fetchLocation: 1");
            // Permission is not granted
            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SightedActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(SightedActivity.this,
                    ...
                    .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            if ( location != null ){
                                ...
                                try{
                                    Geocoder geocoder = new Geocoder(SightedActivity.this, Locale.getDefault());
    ...
    public void onChecked(View view){
        ...
        radioButton = findViewById(selectID);
        if(selectID==-1){
            Toast.makeText(SightedActivity.this,"Please select gender", Toast.LENGTH_SHORT).show();
        }
    }
...
//    }
    ...
    private void getSightedData() {
        ...
        if (f1) {
            Toast.makeText(SightedActivity.this, "Please enter valid details", Toast.LENGTH_SHORT).show();
        } else if (f2) {
            Toast.makeText(SightedActivity.this, "Please enter valid details", Toast.LENGTH_SHORT).show();
        } else if (f3) {
            Toast.makeText(SightedActivity.this, "Please enter valid details", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(SightedActivity.this, "Please select image", Toast.LENGTH_SHORT).show();
        } else {
            ...
            reference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(SightedActivity.this,"Submitted Successfully!!",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(SightedActivity.this, CitizenDashboard.class);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(SightedActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                }
            });
        }
